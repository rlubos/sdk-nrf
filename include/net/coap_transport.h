 ...
 * @details This handle is the socket descriptor that can be used to perform any socket operations
 *          like poll, setsockopt, getsockopt etc.
 */
...
typedef struct {
	...
	/** Transport associated with the local endpoint. This is a socket descriptor. */
