...
#error "TF-M cannot derive the secure flash layout: " \
	"the board's NS partition dtsi is missing a 'nordic,tz-secure' descriptor."
#endif
#if !defined(DT_COMPAT_HAS_OKAY_nordic_tz_nonsecure)
#error "TF-M cannot derive the non-secure flash layout: " \
	"the board's NS partition dtsi is missing a 'nordic,tz-nonsecure' descriptor."
#endif
#endif
